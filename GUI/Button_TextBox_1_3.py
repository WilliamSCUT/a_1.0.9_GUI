...
class Button_TextBox:
    ...
    def __init__(self, label_text = '',text = ''):
        ...
        # 按钮2
        self.button_title_2 = "Standard"
        self.button_size_2 = 20
        self.button_pos_2 = (200, 400)
        self.button_font_2 = "freesansbold.ttf"
        self.button_fontc_2 = (255, 255, 255)
        self.background_2 = COLOR_INACTIVE
        self.button_clic_fc_2 = (255, 255, 255)
        self.button_clic_bgc_2 = (155, 155, 155)
        self.button_if_click_2 = False
        self.button_crash_rect_2 = [0,0,0,0]
        self.edge_2 = 5
        self.width_2 = 0

        # 按钮3
        self.button_title_3 = "Advanced"
        self.button_size_3 = 20
        self.button_pos_3 = (400, 400)
        self.button_font_3 = "freesansbold.ttf"
        self.button_fontc_3 = (255, 255, 255)
        self.background_3 = COLOR_INACTIVE
        self.button_clic_fc_3 = (255, 255, 255)
        self.button_clic_bgc_3 = (155, 155, 155)
        self.button_if_click_3 = False
        self.button_crash_rect_3 = [0,0,0,0]
        self.edge_3 = 5
        self.width_3 = 0
        # 标签部分
        self.label_font = "freesansbold.ttf"
        self.label_fontc = (0,100,0)
        ## 标签1
    ...
    def button_2(self):
        return["bu2", self.button_crash_rect_2, self.button_if_click_2]

    def button_3(self):
        return["bu3", self.button_crash_rect_3, self.button_if_click_3]
    ...
    def button_text_objects_2(self, font):
        text_surface = font.render(self.button_title_2, True, self.button_fontc_2)
        return text_surface, text_surface.get_rect()

    def button_text_objects_3(self, font):
        text_surface = font.render(self.button_title_3, True, self.button_fontc_3)
        return text_surface, text_surface.get_rect()
    ...
    def display(self, scr):
        for n in self.comp:
            ...
            if n[0] == "bu2":
                    ...
                    large_text = pygame.font.Font(self.button_font_2, self.button_size_2)
                    text_surf, text_rect = self.button_text_objects_2(large_text)
                    text_rect.center = self.button_pos_2
                    pygame.draw.rect(scr, self.background_2, (text_rect.left - self.edge_2,
                                                text_rect.top - self.edge_2,
                                                text_rect.width + self.edge_2*2,
                                                text_rect.height+self.edge_2*2), self.width_2)
                    scr.blit(text_surf,text_rect)
                    n[1] = text_rect

            if n[0] == "bu3":
                
                    large_text = pygame.font.Font(self.button_font_3, self.button_size_3)
                    text_surf, text_rect = self.button_text_objects_3(large_text)
                    text_rect.center = self.button_pos_3
                    pygame.draw.rect(scr, self.background_3, (text_rect.left - self.edge_3,
                                                text_rect.top - self.edge_3,
                                                text_rect.width + self.edge_3*2,
                                                text_rect.height+self.edge_3*2), self.width_3)
                    scr.blit(text_surf,text_rect)
                    n[1] = text_rect
            if n[0] == "la1":
        ...
        while go_on:
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if 180<= mouse_x and mouse_x<=220 and 380<=mouse_y and mouse_y<=420:
                        self.button_if_click_2 = not self.button_if_click_2
                        self.button_fontc_2 = COLOR_ACTIVE if self.button_if_click_2 else (255,255,255)
                    
                    if 380 <= mouse_x and mouse_x<=420 and 380<=mouse_y and mouse_y<=420:
                        self.button_if_click_3 = not self.button_if_click_3
                        self.button_fontc_3 = COLOR_ACTIVE if self.button_if_click_3 else (255,255,255)
                    ...
                    if 265<= mouse_x and mouse_x<= 335 and 485 <=  mouse_y and mouse_y <= 515:
                        ...
                        if self.button_if_click_3:
                            gval.set_value("mode",1)
                        go_on = False
                    ...
                    self.box_color4 = COLOR_ACTIVE if self.box_if_click4 else COLOR_INACTIVE
